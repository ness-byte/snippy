...
</div>`, src: "https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-read.svg", title: 'Essential reading well'},
      {snippet:
...
<h2>Optional readings and resources</h2>
  ...
  <p>The following readings will help you develop a deeper understanding of XXX.</p>
    <ul>
      <li>Chapter X: Chapter title (pp. XX–XX) in <em>Book name&nbsp;</em>(Book author, year).</li>
</div>`, src: "https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-read.svg", title: 'Optional reading well'},
      {snippet:
...
</div>`, src: "https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-read.svg", title: 'Combo reading well'},
      {snippet:
...
</div>`, iconClass: 'breaking_news', title: 'Disclaimer well'},
      {snippet:
