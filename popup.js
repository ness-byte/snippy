...
<img src="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Placeholder_Image/Placeholder.png" alt="DESCRIBE THE IMAGE or Refer to transcript">
  ...
  <p><a class="acuo-btn external" role="button" title="Transcript" href="URL of transcript page">Transcript</a></p>
      ...
      {
          snippet: `<div class="acuo_carousel">
...
<figure><img src="https://loremflickr.com/1920/1080?random=3" />
  <figcaption>Caption goes here</figcaption>
      ...
      {
          snippet: `<table class="acuo-table">
...
<figure><!-- Replace this with an iframe from Echo -->
  <figcaption class="sm-font">Video title (Presenter's name, ACU Online, 2025)</figcaption>
      ...
      {
          snippet: `<h2><img role="presentation" src="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-watch.svg" alt="" data-api-endpoint="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-watch.svg" data-api-returntype="File" /> Watch</h2>
<p>CONTENT</p>
<figure> 
...
<figcaption class="sm-font">Video title (Author name, year)</figcaption>
      ...
      {
          snippet: `<div class="acuo_tab" data-tab-layout-type="top">
<div>Tab item 1</div>
<div>
...
<div>
  <p>Item text as follows.</p>
      ...
      {
          snippet: `<div class="acuo_accordion">
<div>First Item</div>
<div>
  <p>Item text as follows.</p>
</div>
...
<div>
  <p>Item text as follows.</p>
      ...
      {
          snippet: `<div class="acuo_click-reveal">
<div>Solution</div>
<div>
...
<!-- End Question block -->
      ...
      {
          snippet: `<div class="yellow-border">
...
<p>Content goes here...</p>
      ...
      {
          snippet: `<div class="essential-reading-well">
...
<p>The following readings XXX.</p>
  <ul>
    <li>Chapter X: Chapter title (pp. XX–XX) in <em>Book name&nbsp;</em>(Book author, year).</li>
      ...
      {
          snippet: `<div class="optional-reading-well">
...
<p>The following readings will help you develop a deeper understanding of XXX.</p>
  <ul>
    <li>Chapter X: Chapter title (pp. XX–XX) in <em>Book name&nbsp;</em>(Book author, year).</li>
      ...
      {
          snippet: `<p>View your Essential and Optional resources by selecting the relevant heading.</p> 
...
<div> 
  ...
  <ul>
    <li>Chapter X: Chapter title (pp. XX–XX) in <em>Book name&nbsp;</em>(Book author, year).</li>
      ...
      {
          snippet: `<div class="disclaimer-well">
...
<p>This unit deals with topics related to <span style="background-color: #fbeeb8;"> ... </span> From time to time, this may create feelings of unease and discomfort. If at any time you feel you need support, please visit an appropriate support service. Additionally, be aware of ethics and social protocols about disclosing personal information in any discussion forum.</p>
      ...
      {
          snippet: `<div class="hanging-indent">
...
<p>Content.</p>
      ...
      {
          snippet: `<p style="text-align: center;"><a class="acuo-btn external" role="button" href="URL of transcript page">Transcript</a></p>`,
...
<hr /> 
<p><span><strong>Navigate back to the main content by using your browser's back button.</strong>&nbsp;</span></p>`,
  ...
  const iconSnippets = [{
          snippet: `<h2><img role="presentation" src="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-activity.svg" alt="" data-api-endpoint="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-activity.svg" data-api-returntype="File" /> Activity</h2>`,
      ...
      {
          snippet: `<h2><img role="presentation" src="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-listen.svg" alt="" data-api-endpoint="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-listen.svg" data-api-returntype="File" /> Listen</h2>`,
          src: 'https://cei-dlc.acucontenthub.acu.edu.au/ShortCourses/Icons/icon-listen.svg',
          title: 'Listen icon'
      },
      {
          snippet: `<h2><img role="presentation" src="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-read.svg" alt="" data-api-endpoint="https://cei-dlc.acucontenthub.acu.edu.au/unitcontent/SharedAssets/Icons/icon-read.svg" data-api-returntype="File" /> Read</h2>`,
